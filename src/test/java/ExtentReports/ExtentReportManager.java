...
public class ExtentReportManager {
    static String reportDir = System.getProperty("user.dir") + "/target/Report/Inventory Test Report.html";
    ...
    public static ExtentReports extentSetup() {
        ...
        extentSparkReporter.config().setReportName("Inventory Test Report");
